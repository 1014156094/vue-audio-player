<template>
  <div class="audio-player">
    <div class="audio__btn-wrap">
      ...
      <div v-show="isShowNotice" class="audio__notice">
        {{ noticeMessage }}
      </div>
    </div>
...
.fade-volume-enter-active {
  animation: fadeVolume 0.5s;
}

.fade-volume-leave-active {
  animation: fadeVolume 0.5s reverse;
}

.fade-rate-enter-active {
  animation: fadeRate 0.5s;
}

.fade-rate-leave-active {
  animation: fadeRate 0.5s reverse;
}
